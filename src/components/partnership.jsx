...
const highlights = [
  { emoji: "🤝", title: "Partnership Requests", desc: "Admins can manage incoming partnership requests and track their status end-to-end." },
  { emoji: "📅", title: "Meeting Scheduling", desc: "Schedule meetings and events with automatic notifications to all relevant members." },
  { emoji: "👤", title: "Profile Management", desc: "Users can register, manage profiles, and view detailed partnership information." },
  { emoji: "🏛️", title: "AAU Integration", desc: "Tailored specifically for Addis Ababa University's partnership ecosystem." },
];
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="relative h-72 md:h-96 overflow-hidden">
        <img src={partnershipImg} alt="Partnership" className="w-full h-full object-cover opacity-30" />
        ...
        <div className="absolute inset-0 flex flex-col justify-end px-6 md:px-16 pb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Partnership Management Platform</h1>
        </div>
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-300 leading-relaxed text-base md:text-lg">
            The Partnership Management Platform is a comprehensive solution designed to facilitate and manage partnerships
            within Addis Ababa University. It allows users to register, manage their profiles, and view partnership
            details, while administrators can manage partnership requests and schedule meetings.
          </p>
          <p className="text-gray-300 leading-relaxed text-base md:text-lg mt-4">
            Built with scalability, security, and performance in mind, the platform ensures data protection and
            reliability. Its intuitive interface caters to users of varying technical abilities, fostering a more
            connected and efficient partnership ecosystem within the university.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          ...
          >
            <FaExternalLinkAlt className="text-lg" /> View Live Demo
          </a>
        </div>
      </div>
    </div>
